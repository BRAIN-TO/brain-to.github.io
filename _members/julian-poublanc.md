...
In 2023, he joined the Brain-TO Lab. His current work focuses on DSC analysis and the development of an automated method for arterial input function (AIF) extraction, initially prototyped in AFNI. This project has since evolved into a standalone Python-based software package for the processing and interactive visualization of DSC and CVR data, encompassing the full workflow from standard preprocessing to parametric map generation, ROI drawing, and signal averaging.
